...
$brand_variants.removeClass().addClass('custom-select mb-3 text-light border-0 ').addClass(active_brand_color)}})(jQuery)
    ...
    $('.open-detele-modal').click(function(){
      var url = $(this).attr('href');
      $('.delete-modal').attr('href', url);
    ...
    $(function() {
      ...
      $('#summernote').summernote()
        ...
        $('.add').click(function() {
            toastr.success('Add successfuly')
          });
    });
    $('#project_name').keyup(function(){
        var getvalue = $(this).val();
        var slug = getvalue.replace(/ /g, "-").toLowerCase(); // Replacing spaces with hyphens and converting to lowercase
        $('#slug').val(slug); // Setting the slug value to #slug input

    })
    $('.slug-create').keyup(function(){
        var getvalue = $(this).val();
        var slug = getvalue.replace(/ /g, "-").toLowerCase(); // Replacing spaces with hyphens and converting to lowercase
        $('#slug').val(slug); // Setting the slug value to #slug input
